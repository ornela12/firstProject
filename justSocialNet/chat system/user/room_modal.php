        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-warning" id="confirm_leave"> Leave</button>
					...
					<div class="form-group input-group">
						...
						<select style="width:350px;" class="form-control" name="user">
							...
							include('../conn.php');
								...
								$u=mysqli_query($conn,"select * from `users` where user_id not in ('".$users."')");
								...
								while($urow=mysqli_fetch_array($u)){
									?>
										<option value="<?php echo $urow['user_id']; ?>"><?php echo $urow['uname']; ?></option>	
									<?php
								}
								}
